...
//      메일 발송 부분
        ...
        String body =
                    "<!DOCTYPE html>\n" +
                            ...
                            "\t\t\t<div id=\"mail_header\" style='margin:0;padding:60px 0 0 35px;height:232px;background-image:url(\"http://sportsaihub.com/mail_topbg.jpg\");background-position:top center;background-repeat:no-repeat;border-bottom:1px solid #ddd;'> \n" +
                            "\t\t\t\t<img src=\"http://sportsaihub.com/mail_logo.png\" alt=\"mail_logo\" style=\"border:0;vertical-align:middle;margin-bottom:20px;\"><h1 style=\"margin:0;padding:0;font-size:32px;\">비밀번호 재설정 요청</h1>\n" +
                            "\t\t\t</div>\n" +
